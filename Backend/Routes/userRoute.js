...
const{bookFlight, getUserById,getCurrentFlights,showFlights,showFlight,cancelFlight,cancelBookedFlight}= require("../Controllers/userController");
...
router.post("/user/booking/cancelBooking",isAuthenticated,cancelBookedFlight);
